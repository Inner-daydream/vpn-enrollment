...
def init():
     subprocess.Popen(['export','AWS_ACCESS_KEY_ID=$_AWS_ACCESS_KEY_ID'],shell=True)
     subprocess.Popen(['export','AWS_SECRET_ACCESS_KEY=$_AWS_SECRET_ACCESS_KEY'],shell=True)
